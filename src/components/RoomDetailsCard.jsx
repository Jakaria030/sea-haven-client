    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 lg:space-x-5'>
            ...
            <div className='lg:px-5 flex flex-col space-y-3 py-5 lg:py-0'>
                ...
                {/* button */}
                <div>
                    <button onClick={() => document.getElementById('book_now_modal').showModal()} className={`w-full px-6 py-2 bg-primary text-secondary font-semibold text-lg rounded-md active:scale-95 transition-all duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed`} disabled={is_booked}>Book Now</button>
                </div>
            </div>
